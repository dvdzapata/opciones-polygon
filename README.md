...
La descarga recorre primero el histórico de 2 años hacia atrás desde la fecha de ejecución para ambos endpoints y evita solicitar datos del día en curso (se corta en el cierre del día anterior). El proceso mantiene progreso para que los reintentos reanuden justo donde se detuvieron sin repetir peticiones.
